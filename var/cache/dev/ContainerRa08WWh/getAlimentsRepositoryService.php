 ...
 */
class getAlimentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AlimentsRepository' shared autowired service.
     *
     * @return \App\Repository\AlimentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AlimentsRepository.php';

        return $container->privates['App\\Repository\\AlimentsRepository'] = new \App\Repository\AlimentsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
