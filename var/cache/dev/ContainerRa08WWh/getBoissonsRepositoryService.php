 ...
 */
class getBoissonsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BoissonsRepository' shared autowired service.
     *
     * @return \App\Repository\BoissonsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BoissonsRepository.php';

        return $container->privates['App\\Repository\\BoissonsRepository'] = new \App\Repository\BoissonsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
