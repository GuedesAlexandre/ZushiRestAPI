...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerXXPy0sw\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerXXPy0sw/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerXXPy0sw/getValidator_ExpressionService.php';
require __DIR__.'/ContainerXXPy0sw/getValidator_EmailService.php';
require __DIR__.'/ContainerXXPy0sw/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerXXPy0sw/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerXXPy0sw/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerXXPy0sw/getSession_FactoryService.php';
require __DIR__.'/ContainerXXPy0sw/getServicesResetterService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerXXPy0sw/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerXXPy0sw/getSecrets_VaultService.php';
require __DIR__.'/ContainerXXPy0sw/getRouting_LoaderService.php';
require __DIR__.'/ContainerXXPy0sw/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerXXPy0sw/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerXXPy0sw/getErrorControllerService.php';
require __DIR__.'/ContainerXXPy0sw/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerXXPy0sw/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerXXPy0sw/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerXXPy0sw/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerXXPy0sw/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/ContainerXXPy0sw/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaSubscriberService.php';
require __DIR__.'/ContainerXXPy0sw/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerXXPy0sw/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerXXPy0sw/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerXXPy0sw/getContainer_GetenvService.php';
require __DIR__.'/ContainerXXPy0sw/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerXXPy0sw/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerXXPy0sw/getCache_ValidatorExpressionLanguageService.php';
require __DIR__.'/ContainerXXPy0sw/getCache_SystemClearerService.php';
require __DIR__.'/ContainerXXPy0sw/getCache_SystemService.php';
require __DIR__.'/ContainerXXPy0sw/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerXXPy0sw/getCache_AppClearerService.php';
require __DIR__.'/ContainerXXPy0sw/getCache_AppService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Openapi_Factory_LegacyService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Metadata_PropertySchema_CollectionRestrictionService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Listener_View_Write_LegacyService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Action_NotExposedService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerXXPy0sw/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerXXPy0sw/getTemplateControllerService.php';
require __DIR__.'/ContainerXXPy0sw/getRedirectControllerService.php';
require __DIR__.'/ContainerXXPy0sw/getCommandesRepositoryService.php';
require __DIR__.'/ContainerXXPy0sw/getBoxsRepositoryService.php';
require __DIR__.'/ContainerXXPy0sw/getBoissonsRepositoryService.php';
require __DIR__.'/ContainerXXPy0sw/getAlimentsRepositoryService.php';
require __DIR__.'/ContainerXXPy0sw/get_ServiceLocator_XUrKPVUService.php';
require __DIR__.'/ContainerXXPy0sw/get_ServiceLocator_THndrlService.php';
require __DIR__.'/ContainerXXPy0sw/get_Container_Private_TwigService.php';
require __DIR__.'/ContainerXXPy0sw/get_Container_Private_SessionService.php';
require __DIR__.'/ContainerXXPy0sw/get_Container_Private_Security_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerXXPy0sw/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerXXPy0sw/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Repository\AlimentsRepository';
$classes[] = 'App\Repository\BoissonsRepository';
$classes[] = 'App\Repository\BoxsRepository';
...
require_once __DIR__.'/twig/c9/c948e11db2a95bd4506b9161710069df.php';
